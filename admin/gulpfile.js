...
gulp.task('build-css', () => {
    return gulp.src(paths.sassSrc.concat('/**/*.scss'))
               .pipe(sass({
...
gulp.task('build-js', () => {
    return gulp.src(paths.jsSrc.concat('/*.js'))
               .pipe(plumber({errorHandler: onError}))
...
gulp.task('build-images', () => {
    return gulp.src(paths.imgSrc.concat('**/*.+(png|jpeg|gif|jpg|svg)'))
...
gulp.task('build-fonts', () => {
    return gulp.src(paths.fontsSrc.concat('**/*.*'))
